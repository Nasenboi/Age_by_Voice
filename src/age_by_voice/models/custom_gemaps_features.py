...
class Custom_GeMAPS_Features(FeaturesModel, Loudness, Zero_Crossing_Rate, Peaks_Per_Second,
                             Harmonics_To_Noise_Ratio, F0, Additional_Spectral_Features, MFCC_1_4):
    """
